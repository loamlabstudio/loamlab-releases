...
const LATEST = {
    ...
    download_url: "https://github.com/loamlabstudio/loamlab-releases/releases/download/v1.4.9/loamlab_plugin.rbz",
...
export default function handler(req, res) {
    ...
    return res.status(200).json({
        ...LATEST,
        release_notes: "Node card UX overhaul: integrated chips/default/labels + sticky preview panel + Project Type node + real-time preview"
    });
}
