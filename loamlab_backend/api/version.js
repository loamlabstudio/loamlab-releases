...
const LATEST = {
    ...
    download_url: "https://github.com/loamlabstudio/loamlab-releases/releases/download/v1.4.15/loamlab_plugin.rbz",
...
export default function handler(req, res) {
    ...
    return res.status(200).json({
        ...LATEST,
        release_notes: "Fix updater: wire check_for_updates/install_update to Ruby; auto-check on startup; remove 404 manage-subscription link"
    });
}
