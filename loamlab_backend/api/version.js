...
const LATEST = {
    ...
    download_url: "https://github.com/loamlabstudio/loamlab-releases/releases/download/v1.4.10/loamlab_plugin.rbz",
...
export default function handler(req, res) {
    ...
    return res.status(200).json({
        ...LATEST,
        release_notes: "Fix missing translations (SHARE/INVITE), full i18n dynamic sync, auto-localized IG modals"
    });
}
