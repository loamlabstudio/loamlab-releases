...
const LATEST = {
    ...
    download_url: "https://github.com/loamlabstudio/loamlab-releases/releases/download/v1.4.5/loamlab_plugin.rbz",
...
export default function handler(req, res) {
    ...
    return res.status(200).json({
        ...LATEST,
        release_notes: "Fix duplicate exports + Enforce project name in filenames"
    });
}
