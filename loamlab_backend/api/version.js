...
const LATEST = {
    ...
    download_url: "https://github.com/loamlabstudio/loamlab-releases/releases/download/v1.4.14/loamlab_plugin.rbz",
...
export default function handler(req, res) {
    ...
    return res.status(200).json({
        ...LATEST,
        release_notes: "Fix render history: support simplified/ASCII filenames; auto version bump in release script"
    });
}
